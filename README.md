[![Open in Codespaces](https://classroom.github.com/assets/launch-codespace-2972f46106e565e64193e422d61a12cf1da4916b45550586e14ef0a7c637dd04.svg)](https://classroom.github.com/open-in-codespaces?assignment_repo_id=21074055)
# scrabbleGame
...
While working on my Scrabble game, I really got to see how object-oriented programming ties everything together. Before this project, classes and constructors felt kind of abstract, but building the Word class helped me understand how objects can store both data and behavior. I also learned how useful data structures like ArrayList are when managing lots of objects, especially when sorting and searching through them. One challenge I ran into was getting the binary search to correctly match words regardless of case. I fixed it by comparing everything in lowercase, which taught me how small logic details can affect a program’s output. I used ChatGPT (the GPT-5 model) to help me understand errors and clean up my comments so they made sense in plain English. I also used a few online Java references when I got stuck with file reading. Debugging this project gave me a better grasp of how different parts of a program communicate, and honestly made OOP feel more natural to me.
